...
class MEComponent(cobra.core.metabolite.Metabolite):
	...
	def get_fluxes(self,
		...
		threshold = 0., flux_dict = 0, include_zeroes = True, print_reactions = True,
		...
		"""
		return coralme.util.flux_analysis.flux_based_reactions(self._model, self.id, only_types, ignore_types, threshold, flux_dict, include_zeroes, solution, aliases, keffs, print_reactions, verbose)
