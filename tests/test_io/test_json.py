...
def test_save_json_me_model(shared_builder_troubleshooted):
    ...
    save_json_me_model(builder1.me_model,"./tests/data/base_model/{}.json".format(builder1.me_model.id))

def test_load_json_me_model(shared_builder_troubleshooted):
    builder1 = pytest.shared_builder_troubleshooted
    model = load_json_me_model("./tests/data/base_model/{}.json".format(builder1.me_model.id))
    model.optimize()
